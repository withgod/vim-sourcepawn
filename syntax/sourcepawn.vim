...
" Generated by vim.pl
" Generated at 2015-02-21 14:26:15 -0500
...
" adminmenu.inc
syn keyword	cFunction	AddTargetsToMenu AddTargetsToMenu2 RedisplayAdminMenu 
...
" adt_array.inc
syn keyword	cFunction	ByteCountToCells   
...
" adt_trie.inc
syn keyword	cFunction	CreateTrie RemoveFromTrie ClearTrie GetTrieSize
syn keyword	cFunction	TrieSnapshotLength TrieSnapshotKeyBufferSize GetTrieSnapshotKey 
syn keyword	cConstant	native native native native
syn keyword	cConstant	native native native native
syn keyword	cConstant	native native native native
...
syn keyword	cFunction	GetClientIP GetClientAuthString GetClientAuthId GetSteamAccountID
syn keyword	cFunction	GetClientUserId IsClientConnected IsClientInGame IsClientInKickQueue
syn keyword	cFunction	IsPlayerInGame IsClientAuthorized IsFakeClient IsClientSourceTV
syn keyword	cFunction	IsClientReplay IsClientObserver IsPlayerAlive GetClientInfo
syn keyword	cFunction	GetClientTeam SetUserAdmin GetUserAdmin AddUserFlags
syn keyword	cFunction	RemoveUserFlags SetUserFlagBits GetUserFlagBits CanUserTarget
syn keyword	cFunction	RunAdminCacheChecks NotifyPostAdminCheck CreateFakeClient SetFakeClientConVar
syn keyword	cFunction	GetClientHealth GetClientModel GetClientWeapon GetClientMaxs
syn keyword	cFunction	GetClientMins GetClientAbsAngles GetClientAbsOrigin GetClientArmor
syn keyword	cFunction	GetClientDeaths GetClientFrags GetClientDataRate IsClientTimingOut
syn keyword	cFunction	GetClientTime GetClientLatency GetClientAvgLatency GetClientAvgLoss
syn keyword	cFunction	GetClientAvgChoke GetClientAvgData GetClientAvgPackets GetClientOfUserId
syn keyword	cFunction	KickClient KickClientEx ChangeClientTeam GetClientSerial
syn keyword	cFunction	GetClientFromSerial   
...
syn keyword	cForward	OnClientConnect OnClientCommand OnClientPreAdminCheck 
...
" commandline.inc
syn keyword	cFunction	GetCommandLine GetCommandLineParam GetCommandLineParamInt GetCommandLineParamFloat
syn keyword	cFunction	FindCommandLineParam   
...
syn keyword	cFunction	GetCmdArgs GetCmdArg GetCmdArgString GetCommandIterator
syn keyword	cFunction	ReadCommandIterator CheckCommandAccess CheckAccess GetCommandFlags
syn keyword	cFunction	SetCommandFlags FindFirstConCommand FindNextConCommand AddServerTag
syn keyword	cFunction	RemoveServerTag AddCommandListener RemoveCommandListener CommandExists
syn keyword	cConstant	INVALID_FCVAR_FLAGS QUERYCOOKIE_FAILED SM_REPLY_TO_CONSOLE SM_REPLY_TO_CHAT
syn keyword	cConstant	FCVAR_NONE FCVAR_UNREGISTERED FCVAR_LAUNCHER FCVAR_GAMEDLL
syn keyword	cConstant	FCVAR_CLIENTDLL FCVAR_MATERIAL_SYSTEM FCVAR_PROTECTED FCVAR_SPONLY
syn keyword	cConstant	FCVAR_ARCHIVE FCVAR_NOTIFY FCVAR_USERINFO FCVAR_PRINTABLEONLY
syn keyword	cConstant	FCVAR_UNLOGGED FCVAR_NEVER_AS_STRING FCVAR_REPLICATED FCVAR_CHEAT
syn keyword	cConstant	FCVAR_STUDIORENDER FCVAR_DEMO FCVAR_DONTRECORD FCVAR_PLUGIN
syn keyword	cConstant	FCVAR_DATACACHE FCVAR_TOOLSYSTEM FCVAR_FILESYSTEM FCVAR_NOT_CONNECTED
syn keyword	cConstant	FCVAR_SOUNDSYSTEM FCVAR_ARCHIVE_XBOX FCVAR_INPUTSYSTEM FCVAR_NETWORKSYSTEM
syn keyword	cConstant	FCVAR_VPHYSICS FEATURECAP_COMMANDLISTENER  
syn keyword	cTag		QueryCookie ReplySource  
syn keyword	cForward	OnClientSayCommand   
...
syn keyword	cConstant	PlInfo_URL char char bool
syn keyword	cConstant	bool char char bool
syn keyword	cConstant	NULL_VECTOR NULL_STRING  
...
syn keyword	cConstant	CSWeapon_NONE CSWeapon_P228 CSWeapon_GLOCK CSWeapon_SCOUT
syn keyword	cConstant	CSWeapon_HEGRENADE CSWeapon_XM1014 CSWeapon_C4 CSWeapon_MAC10
syn keyword	cConstant	CSWeapon_AUG CSWeapon_SMOKEGRENADE CSWeapon_ELITE CSWeapon_FIVESEVEN
syn keyword	cConstant	CSWeapon_UMP45 CSWeapon_SG550 CSWeapon_GALIL CSWeapon_FAMAS
syn keyword	cConstant	CSWeapon_USP CSWeapon_AWP CSWeapon_MP5NAVY CSWeapon_M249
syn keyword	cConstant	CSWeapon_M3 CSWeapon_M4A1 CSWeapon_TMP CSWeapon_G3SG1
syn keyword	cConstant	CSWeapon_FLASHBANG CSWeapon_DEAGLE CSWeapon_SG552 CSWeapon_AK47
syn keyword	cConstant	CSWeapon_KNIFE CSWeapon_P90 CSWeapon_SHIELD CSWeapon_KEVLAR
syn keyword	cConstant	CSWeapon_ASSAULTSUIT CSWeapon_NIGHTVISION CSWeapon_GALILAR CSWeapon_BIZON
syn keyword	cConstant	CSWeapon_MAG7 CSWeapon_NEGEV CSWeapon_SAWEDOFF CSWeapon_TEC9
syn keyword	cConstant	CSWeapon_TASER CSWeapon_HKP2000 CSWeapon_MP7 CSWeapon_MP9
syn keyword	cConstant	CSWeapon_NOVA CSWeapon_P250 CSWeapon_SCAR17 CSWeapon_SCAR20
syn keyword	cConstant	CSWeapon_SG556 CSWeapon_SSG08 CSWeapon_KNIFE_GG CSWeapon_MOLOTOV
syn keyword	cConstant	CSWeapon_DECOY CSWeapon_INCGRENADE CSWeapon_DEFUSER 
...
" datapack.inc
syn keyword	cConstant	DataPack WriteCell WriteFloat WriteString
syn keyword	cConstant	WriteFunction ReadCell ReadFloat ReadString
syn keyword	cConstant	ReadFunction Reset IsReadable get
syn keyword	cConstant	set   

" dbi.inc
syn keyword	cFunction	SQL_ExecuteTransaction   
...
syn keyword	cFunction	FindSendPropOffs FindSendPropInfo FindDataMapOffs FindDataMapInfo
syn keyword	cFunction	GetEntSendPropOffs GetEntProp SetEntProp GetEntPropFloat
syn keyword	cFunction	SetEntPropFloat GetEntPropEnt SetEntPropEnt GetEntPropVector
syn keyword	cFunction	SetEntPropVector GetEntPropString SetEntPropString GetEntPropArraySize
...
" files.inc
syn keyword	cFunction	GetFileTime   
...
syn keyword	cFunction	__FLOAT_GT__ __FLOAT_GE__ __FLOAT_LT__ __FLOAT_LE__
syn keyword	cFunction	__FLOAT_EQ__ __FLOAT_NE__ __FLOAT_NOT__ DegToRad
syn keyword	cFunction	RadToDeg GetURandomInt GetURandomFloat SetURandomSeed
syn keyword	cFunction	SetURandomSeedSimple   
...
syn keyword	cFunction	SetNativeArray FormatNativeString RequestFrame 
...
syn keyword	cConstant	Engine_Contagion INVALID_ENT_REFERENCE RangeType_Visibility RangeType_Audibility
syn keyword	cTag		DialogType EngineVersion ClientRangeType 

" handles.inc
syn keyword	cFunction	CloseHandle CloneHandle IsValidHandle 
syn keyword	cConstant	INVALID_HANDLE Close ~Handle 
syn keyword	cTag		Handle   

" helpers.inc
syn keyword	cFunction	FormatUserLogText FindPluginByFile FindTarget LoadMaps
...
" logging.inc
syn keyword	cFunction	LogMessage LogToFile LogToFileEx LogAction
syn keyword	cFunction	LogError AddGameLogHook RemoveGameLogHook 
...
syn keyword	cFunction	EnterProfilingEvent LeaveProfilingEvent IsProfilingActive 
...
syn keyword	cConstant	Regex Match GetSubString 
...
syn keyword	cConstant	SDKHook_BlockedPost SDKHook_OnTakeDamageAlive SDKHook_OnTakeDamageAlivePost Use_Off
syn keyword	cConstant	Use_On Use_Set Use_Toggle Extension
syn keyword	cTag		SDKHookType UseType  

" sdktools.inc
syn keyword	cFunction	StartPrepSDKCall PrepSDKCall_SetVirtual PrepSDKCall_SetSignature PrepSDKCall_SetAddress
syn keyword	cFunction	PrepSDKCall_SetFromConf PrepSDKCall_SetReturnInfo PrepSDKCall_AddParameter EndPrepSDKCall
syn keyword	cFunction	SDKCall GetPlayerResourceEntity  
...
syn keyword	cConstant	VENCODE_FLAG_COPYBACK   
...
syn keyword	cFunction	GetTeamClientCount SetEntityModel GetPlayerDecalFile GetPlayerJingleFile
syn keyword	cFunction	GetServerNetStats EquipPlayerWeapon ActivateEntity SetClientInfo
syn keyword	cFunction	GivePlayerAmmo   
...
syn keyword	cFunction	StopSound EmitSound EmitSoundEntry EmitSentence
syn keyword	cFunction	GetDistGainFromSoundLevel AddAmbientSoundHook AddNormalSoundHook RemoveAmbientSoundHook
syn keyword	cFunction	RemoveNormalSoundHook EmitSoundToClient EmitSoundToAll ATTN_TO_SNDLEVEL
syn keyword	cFunction	GetGameSoundParams EmitGameSound EmitAmbientGameSound EmitGameSoundToClient
syn keyword	cFunction	EmitGameSoundToAll PrecacheScriptSound  
...
syn keyword	cForward	AskPluginLoad AskPluginLoad2 OnClientFloodCheck 
...
syn keyword	cFunction	CharToLower StrCat ExplodeString ImplodeStrings

" testing.inc

" textparse.inc
syn keyword	cFunction	SMC_SetParseStart SMC_SetParseEnd  
...
syn keyword	cFunction	TF2_IsHolidayActive TF2_IsPlayerInDuel TF2_RemoveWearable 
...
syn keyword	cConstant	TFCond_HalloweenInHell TFCond_HalloweenGhostMode TFCond_DodgeChance TFCond_Parachute
syn keyword	cConstant	TFCond_BlastJumping TFCond_HalloweenKart TFCond_HalloweenKartDash TFCond_BalloonHead
syn keyword	cConstant	TFCond_MeleeOnly TFCond_SwimmingCurse TFCond_HalloweenKartNoTurn TFCond_HalloweenKartCage
...
syn keyword	cConstant	TFCond_RuneAgility TFHoliday_Invalid TFHoliday_Birthday TFHoliday_Halloween
syn keyword	cConstant	TFHoliday_Christmas TFHoliday_EndOfTheLine TFHoliday_ValentinesDay TFHoliday_MeetThePyro
syn keyword	cConstant	TFHoliday_SpyVsEngyWar TFHoliday_FullMoon TFHoliday_HalloweenOrFullMoon TFHoliday_HalloweenOrFullMoonOrValentines
syn keyword	cConstant	TFHoliday_AprilFools TFObject_CartDispenser TFObject_Dispenser TFObject_Teleporter
syn keyword	cConstant	TFObject_Sentry TFObject_Sapper TFObjectMode_None TFObjectMode_Entrance
syn keyword	cConstant	TFObjectMode_Exit   
...
" tf2_stocks.inc
syn keyword	cFunction	TF2_GetClientTeam TF2_GetPlayerClass TF2_SetPlayerClass TF2_GetPlayerResourceData
syn keyword	cFunction	TF2_SetPlayerResourceData TF2_RemoveWeaponSlot TF2_RemoveAllWeapons TF2_GetPlayerConditionFlags
syn keyword	cFunction	TF2_IsPlayerInCondition TF2_GetObjectType TF2_GetObjectMode 
...
syn keyword	cConstant	native native native native
syn keyword	cConstant	native native native native
syn keyword	cConstant	native Extension  
