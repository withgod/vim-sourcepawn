...
" Generated by vim.pl
" Generated at 2012-02-29 15:43:21 +0900
...
syn keyword	cFunction	IsClientSourceTV IsClientReplay IsClientObserver IsPlayerAlive
syn keyword	cFunction	GetClientInfo GetClientTeam SetUserAdmin GetUserAdmin
syn keyword	cFunction	AddUserFlags RemoveUserFlags SetUserFlagBits GetUserFlagBits
...
syn keyword	cFunction	GetClientOfUserId KickClient KickClientEx ChangeClientTeam
syn keyword	cFunction	GetClientSerial GetClientFromSerial  
...
syn keyword	cFunction	SetEntDataArray GetEntityClassname  
...
syn keyword	cConstant	FL_TRANSRAGDOLL FL_UNBLOCKABLE_BY_PLAYER FL_FREEZING FL_EP2V_UNKNOWN1
...
syn keyword	cFunction	DisplayAskConnectBox EntIndexToEntRef EntRefToEntIndex MakeCompatEntRef
syn keyword	cConstant	SOURCE_SDK_UNKNOWN SOURCE_SDK_ORIGINAL SOURCE_SDK_DARKMESSIAH SOURCE_SDK_EPISODE1
syn keyword	cConstant	SOURCE_SDK_EPISODE2 SOURCE_SDK_BLOODYGOODTIME SOURCE_SDK_EYE SOURCE_SDK_EPISODE2VALVE
syn keyword	cConstant	SOURCE_SDK_LEFT4DEAD SOURCE_SDK_LEFT4DEAD2 SOURCE_SDK_ALIENSWARM MOTDPANEL_TYPE_TEXT
syn keyword	cConstant	MOTDPANEL_TYPE_INDEX MOTDPANEL_TYPE_URL MOTDPANEL_TYPE_FILE DialogType_Msg
syn keyword	cConstant	DialogType_Menu DialogType_Text DialogType_Entry DialogType_AskConnect
...
syn keyword	cConstant	RoundState_GameOver RoundState_Bonus  
...
syn keyword	cConstant	TFCond_SpeedBuffAlly TFCond_HalloweenCritCandy TFCond_CritHype TFCond_CritOnFirstBlood
syn keyword	cConstant	TFCond_CritOnWin TFCond_CritOnFlagCapture TFCond_CritOnKill TFCond_RestrictToMelee
syn keyword	cConstant	TFHoliday_Birthday TFHoliday_Halloween TFHoliday_FullMoon TFHoliday_HalloweenOrFullMoon
...
syn keyword	cForward	TF2_OnConditionRemoved TF2_OnWaitingForPlayersStart TF2_OnWaitingForPlayersEnd 
